...
En este caso se utiliza la herramienta visual que netbeans provee para poder realizar la GUI
...
public class CalculadoraAnuncio extends javax.swing.JFrame {
    ...
    /**
     * Creates new form CalculadoraAnuncio
     */
    ...
    private void initComponents() {
        ...
        jButton2.setFont(new java.awt.Font("Perpetua Titling MT", 1, 48)); // NOI18N
        jButton2.setText("NUEVO ANUNCIO");
        jButton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton2ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 290, 510, 90));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 400, 510, 60));

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/CapaUsuario/Fondo.png"))); // NOI18N
...
//ABRE LA CALCULADORA PUBLICITARIA 
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed

        // se lee la informacion de los archivos al iniciar el programa
        /*
